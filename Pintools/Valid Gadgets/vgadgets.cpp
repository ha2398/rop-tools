 ...
 *
 * vgadgets.cpp: Pintool used to determine valid calls in an application's
 * execution.
 */
...
KNOB<string> outFileKnob(KNOB_MODE_WRITEONCE, "pintool", "o", \
	"vgadgets_out.log", "Output file name");
...
static ofstream callFile; // Valid Calls output file
